...
#cowin_api_call('https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByDistrict?district_id={}&date={}',id=294,numdays=8,age=19,from_user_id='shravanpuranik@gmail.com',to_user_id='shravanpuranik@gmail.com',email_password='tymiklnekfqgzkkw',sleep_secs=120,mailing_activity='n')
